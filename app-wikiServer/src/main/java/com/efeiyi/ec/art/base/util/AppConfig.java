...
public class AppConfig {
    ...
    public static final String SQL_MESSAGE_GET_APP ="select *,COUNT(case when isWatch='0' then :userId  else null end) as isRead FROM Message where targetUser.id = :userId and status = \"1\" GROUP BY fromUser.id ORDER BY createDatetime DESC";
