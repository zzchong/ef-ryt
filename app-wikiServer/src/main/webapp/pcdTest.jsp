...
<div class="am-g">
  ...
  <script type="text/javascript">
    $(function(){
      $("#pcdDiv").pcdSelect(
              "<c:url value='/app/provinceList.do'/>",
              "<c:url value='/app/cityListByProvince.do?conditions=addressProvince.id:'/>",
              "<c:url value='/app/districtListByCity.do?conditions=addressCity.id:'/>",
              "${object.province.id}",
              "${object.city.id}",
              "${object.district.id}"
      )
