...
<div class="am-cf am-padding">
  <div class="am-fl am-cf">
    <strong class="am-text-primary am-text-lg">审核项目列表</strong>
  </div>
</div>
      ...
      <td>
        <div class="am-btn-toolbar">
          <div class="am-btn-group am-btn-group-xs" style="width: 100%;" >
            <button onclick="window.location.href='<c:url value="/checkProject/remove.do?id=${artwork.id}"/>'"
            ...
            <c:if test="${artwork.step == '10'}">
              <button onclick="window.location.href='<c:url value="/checkProject/checkPass.do?id=${artwork.id}&type=${artwork.step}"/>'"
            ...
            <c:if test="${artwork.step == '11'}">
              ...
              <button <%--onclick="window.location.href='<c:url value="/checkProject/checkReject.do?id=${artwork.id}"/>'"--%>
