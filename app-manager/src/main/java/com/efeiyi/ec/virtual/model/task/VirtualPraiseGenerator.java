...
import com.efeiyi.ec.art.virtual.model.VirtualPraisePlan;
 ...
 */
public class VirtualPraiseGenerator extends BaseTimerTask {

    private VirtualPraisePlan virtualPraisePlan;
    private Map jsonMap;


    public VirtualPraiseGenerator(Map jsonMap, VirtualPraisePlan virtualPraisePlan) {
    ...
    public void execute(List<VirtualPlan> virtualPlanList) {
        ...
        String url = virtualPraisePlan.getUrl();
